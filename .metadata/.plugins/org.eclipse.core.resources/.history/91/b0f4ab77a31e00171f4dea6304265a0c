   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   if (Integer.valueOf(request.getParameter("option"))==1) {
		...
		try {
			...
			jsonResponse=resource.getKPI(String.valueOf(request.getParameter("parameter1")),String.valueOf(request.getParameter("parameter2")),String.valueOf(request.getParameter("parameter3")),String.valueOf(request.getParameter("parameter4")));
	   ...
	   if (Integer.valueOf(request.getParameter("option"))==2) {
			...
			String jsonResponse="";
			try {
				jsonResponse=resource.getAllMeasuresCnt(String.valueOf(request.getParameter("country")),String.valueOf(request.getParameter("service")),String.valueOf(request.getParameter("rowno")),"",String.valueOf(request.getParameter("date1")),String.valueOf(request.getParameter("date2")));
				conn.close();
			} catch (SQLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
